...
import { AdminBoothControl, AdminBookings, AdminEvents, BookingDetail, BookingEvents, MyBookings, PublicEvent, PublicEvents } from './Booking'
...
const adminNav=[['/admin',LayoutDashboard,'Overview'],['/admin/events',CalendarDays,'Events'],['/admin/booths',Map,'Booth control'],['/admin/bookings',TicketCheck,'Reservations'],['/admin/entrepreneurs',Users,'Entrepreneurs'],['/admin/settings',Settings,'Settings']]
